/** @see https://stackoverflow.com/a/35532028 에서 가저옴 */
...
public class WinRegistry {
     ...
     * gives
     * only first occurrence value of the key. If required to get all values in the
     * path
     * recursively for this key, then
     * {@link #valuesForKeyPath(int hkey, String path, String key)}
     * should be used.
     * 
     * @param hkey
     * @param path
