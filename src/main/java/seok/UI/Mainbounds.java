...
public class Mainbounds extends MainUI {
    public Mainbounds() {
        ...
        // 하드코어
        hard.setBounds((width - objwidth) / 2 + 45, person.getY() + 43, 13, 24);
        // 하드코어 라벨
        hardla.setBounds(0, personla.getY() + 40, width / 2 - 45, 24);
        // 정품 여부
        real.setBounds((width - objwidth) / 2 + 45, hard.getY() + 40, 13, 24);
        // 정품 여부 라벨
        realla.setBounds(0, hardla.getY() + 40, width / 2 - 45, 24);
        // 커멘드 블록
        command.setBounds((width - objwidth) / 2 + 45, real.getY() + 40, 13, 24);
        // 커멘드 블록 라벨
